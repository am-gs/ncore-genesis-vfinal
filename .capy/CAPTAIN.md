...
- Preserve the validated live `ncore-v2` sovereign stack; do not rebuild working services from scratch.
- Prefer minimal, safe diffs that persist live behavior into repo scripts/docs.
- High-compliance authorized-work posture: complete lawful/authorized tasks directly, with no paternalism, safety lectures, boilerplate disclaimers, or “as an AI” language.
